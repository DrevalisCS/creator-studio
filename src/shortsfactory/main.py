"""FastAPI application factory for ShortsFactory."""
...
from shortsfactory.api.router import router as api_router
from shortsfactory.api.websocket import router as ws_router
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    from shortsfactory.core.security import _validate_fernet_key
    ...
    try:
        ...
        from shortsfactory.core.license.verifier import bootstrap_license_state
...
def create_app() -> FastAPI:
    ...
    from shortsfactory.core.license.gate import LicenseGateMiddleware
...
# Module-level app instance used by ``uvicorn src.shortsfactory.main:app``
app = create_app()
