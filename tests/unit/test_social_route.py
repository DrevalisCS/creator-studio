...
def _make_upload(**overrides: Any) -> Any:
    ...
    u.platform_content_id = overrides.get("platform_content_id", None)
    u.platform_url = overrides.get("platform_url", None)
    ...
    u.error_message = overrides.get("error_message", None)
