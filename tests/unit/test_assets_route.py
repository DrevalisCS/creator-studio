...
def _make_asset(**overrides: Any) -> Any:
    ...
    a.width = overrides.get("width", None)
    a.height = overrides.get("height", None)
    a.duration_seconds = overrides.get("duration_seconds", None)
    a.tags = overrides.get("tags", [])
    a.description = overrides.get("description", None)
